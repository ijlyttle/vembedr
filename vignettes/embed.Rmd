...
The browser within the RStudio IDE does not support the use of iframes that point to external URLs. You are encouraged to open this vignette in a different browser, such as Chrome or Firefox. This page is also available using the [GitHub pages](http://ijlyttle.github.io/vembedr/) service.
