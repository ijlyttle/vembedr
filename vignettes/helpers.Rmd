...
If you need to make additional customization, you can usethe `suggest_embed()` function (which this function uses) to provide the R code, which you can then modify to your needs.
